...
namespace Seminar_3
{
    ...
    public class TaxesClassTest
    {
        ...
        public void Jointly_0()
        {
            ...
            double income = 0;
            double expectedTax = 0;
            double tax = taxes.MarriedFilingJointly(income);
            Assert.AreEqual(expectedTax, tax, 0.00);
        }
        ...
        public void Separately_0()
        {
            ...
            double income = 0;
            double expectedTax = 0;
            double tax = taxes.MarriedFilingSeparately(income);
            Assert.AreEqual(expectedTax, tax, 0.00);
        }
        ...
        public void Head_0()
        {
            ...
            double income = 0;
            double expectedTax = 0;
            double tax = taxes.HeadOfHousehold(income);
            Assert.AreEqual(expectedTax, tax, 0.00);
        }
