...
namespace Employee_Benefits.Unit_Tests.EB.Core
{
    ...
    public class Employee_Record_Search
    {
        ...
        public void Create_Employee_List()
        {
            ...
            Employee_List[0].Employee_ID = 100;
            Employee_List[0].Employee_Type = 10;
            Employee_List[0].Employee_Comp = 10;
            ...
            Employee_List[1].Employee_Comp = 5;
            Employee_List[1].Employee_PTO = 20;

            Employee_List[2] = new Employee();
            Employee_List[2].Employee_ID = 300;
            Employee_List[2].Employee_Type = 30;
            Employee_List[2].Employee_Comp = 0;
        ...
        {
            Result_Employee = Benefit_Actions.Find_Employee(Employee_List, 100);
        ...
        {
            Result_Employee = Benefit_Actions.Find_Employee(Employee_List, 400);
